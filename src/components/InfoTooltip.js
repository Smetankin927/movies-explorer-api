...
function InfoTooltip(props) {
  // const succesMessage = location.pathname === "/signin"?"Вы успешно Зарегистрировались":{location.pathname === "/signup"?"Вы успешно Вошли в систему":};
    ...
    >
      <div className="popup__container">
        ...
        <h2 className="popup__title popup__title-registration">
          {props.isSucces
            ? props.tooltipMessages.succesMessage
            : props.tooltipMessages.failMessage}{" "}
        </h2>
      </div>
    </section>
  );
